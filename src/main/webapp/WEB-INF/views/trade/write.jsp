...
<main class="flex-grow flex items-center justify-center">
    <div class="bg-white shadow-md rounded px-8 py-6 w-full max-w-lg">
        <h1 class="text-xl font-bold text-center text-red-600 mb-4">중고거래 글쓰기</h1>
        <form action="${pageContext.request.contextPath}/trade/write" method="post" class="space-y-4">
            <div>
            ...
            <div>
                ...
                <select id="productId" name="productId"
                    ...
                    <c:forEach var="userCar" items="${userCars}"> <%-- UserCar 목록 iteration --%>
                        <option value="${userCar.userCarId}">
            ...
            <button type="submit" class="w-full bg-red-600 text-white py-2 rounded hover:bg-red-500">작성 완료</button>
        </form>
    </div>
</main>
